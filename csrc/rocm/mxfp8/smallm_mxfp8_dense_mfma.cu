...
#include "arch.h"  // vllm_mxfp8::is_gfx950()
...
at::Tensor smallm_mxfp8_mfma(
    ...
    int64_t k_splits)
{
    TORCH_CHECK(vllm_mxfp8::is_gfx950(),
                "smallm_mxfp8_mfma requires a CDNA4 (gfx950) device");
...
// Bound in csrc/rocm/torch_bindings.cpp (torch.ops._rocm_C.smallm_mxfp8_mfma).
